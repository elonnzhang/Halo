...
///
/// The AX globals (`kAXTrustedCheckOptionPrompt`) are CFString constants;
/// `@preconcurrency import ApplicationServices` is what lets us read them
/// from a non-isolated context. Callers can be on any actor.
